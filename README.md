...
- During the final 3 minutes of trading, if the bid or last trade price for either side goes above a user-configurable value (bydefault $0.70), we will place a limit order for a user-configurable number of shares (by default 20) for that side.  
