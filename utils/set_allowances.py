...
# This script will set allowances on your wallet to enable trading on Polymarket
# It is based on the latest script from this Gist:
#    https://gist.github.com/poly-rodr/44313920481de58d5a3f6d1f8226bd5e
# with some fixes for the use of checksum addresses

from web3 import Web3
from web3.constants import MAX_INT
from web3.middleware import ExtraDataToPOAMiddleware

priv_key = "[PRIVATE_KEY]" # Polygon account private key (needs some MATIC);  no leading 0x
pub_key = Web3.to_checksum_address("[WALLET_ADDRESS]") # Polygon account public key corresponding to private key, including leading 0x
